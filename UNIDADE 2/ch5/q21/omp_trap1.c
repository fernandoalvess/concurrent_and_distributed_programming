...
int main(int argc, char* argv[]) {
   ...
   int     thread_count;
   double start_time, finish_time, time_result;
   time_result = 0;
...
#  pragma omp parallel num_threads(thread_count) default (none) shared(global_result, a, b, n, time_result) private(start_time, finish_time)
   {
#  pragma omp barrier
