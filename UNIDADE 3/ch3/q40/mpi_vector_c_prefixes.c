 ...
 *
 * Compile:  mpicc -g -Wall -o mpi_vector_c_prefixes mpi_vector_c_prefixes.c -lm
 * Usage:    mpiexec -n<number of processes> ./mpi_vector_c_prefixes
 */
#include <stdio.h>
#include <mpi.h> 
#include <stdlib.h>
...
int main(void) {
   ...
   Read_vector(vector_x, n, "X", my_rank, MPI_COMM_WORLD);
